...
public:
	...
	int CollisionSphere(CCollTriangle *out, const CVector3D &center, float radius, int maxcnt, int raws, int rawe, int cols, int cole,int matNo);
	int CollisionCupsel(CCollTriangle *out, const CVector3D &top, const CVector3D &bottom, float radius, int maxcnt, int raws, int rawe, int cols, int cole, int matNo);
